...
pub fn disassemble(inst: u32, inst_type: Instruction) -> String {
  ...
  match inst_type {
    ...
    Instruction::Register(RegisterType::SUBW) => format!("subw  {}, {}, {}", rd, rs1, rs2),
    ...
    Instruction::Register(RegisterType::SRAW) => format!("sraw  {}, {}, {}", rd, rs1, rs2),
    ...
    Instruction::Immediate(ImmediateType::SLLIW) => format!("slliw {}, {}, {}", rd, rs1, imm),
    Instruction::Immediate(ImmediateType::SRLI)  => format!("srli  {}, {}, {}", rd, rs1, imm),
    Instruction::Immediate(ImmediateType::SRLIW) => format!("srliw {}, {}, {}", rd, rs1, imm),
    ...
    Instruction::Register(RegisterType::MUL)  => format!("mul   {}, {}, {}", rd, rs1, rs2),
    Instruction::Register(RegisterType::MULW) => format!("mulw  {}, {}, {}", rd, rs1, rs2),
    Instruction::Register(RegisterType::DIV)  => format!("div   {}, {}, {}", rd, rs1, rs2),
    Instruction::Register(RegisterType::DIVU) => format!("divu  {}, {}, {}", rd, rs1, rs2),
    Instruction::Register(RegisterType::DIVW) => format!("divw  {}, {}, {}", rd, rs1, rs2),
    Instruction::Register(RegisterType::REM)  => format!("rem   {}, {}, {}", rd, rs1, rs2),
    Instruction::Register(RegisterType::REMU) => format!("remu  {}, {}, {}", rd, rs1, rs2),
    Instruction::Register(RegisterType::REMW) => format!("remw  {}, {}, {}", rd, rs1, rs2),
